...
#else
	config.setMaxWorkspaceSize(roundToBytes(build.workspace));
#endif
    }
    if (build.dlaSRAM >= 0)
    {
...
#else
	config.setMaxWorkspaceSize(roundToBytes(build.dlaSRAM));
#endif
    }
...
#else
	config.setMaxWorkspaceSize(roundToBytes(build.dlaLocalDRAM));
#endif
    }
...
#else
	config.setMaxWorkspaceSize(roundToBytes(build.dlaGlobalDRAM));
#endif
    }
}
