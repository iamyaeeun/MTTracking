...
public:
        ...
        , mBatchSize(batchSize)
    {
        ...
        // _lkh this assert statement makes a trouble even though the network is created with 
        // option, NetworkDefinitionCreationFlag::kEXPLICIT_BATCH
        // So temporally comment it out until find exact RC
